...
export const ICICI_HMAC_ALGO = String(process.env.ICICI_HMAC_ALGO || "sha256").trim();
export const ICICI_INITIATE_SALE_URL = String(process.env.ICICI_INITIATE_SALE_URL || "https://pgpayuat.icicibank.com/tsp/pg/api/v2/initiateSale").trim();
export const ICICI_STATUS_CHECK_URL = String(process.env.ICICI_STATUS_CHECK_URL || "https://pgpayuat.icicibank.com/tsp/pg/api/command").trim();
export const ICICI_AUTH_REDIRECT_URL = String(process.env.ICICI_AUTH_REDIRECT_URL || "https://pgpayuat.icicibank.com/tsp/pg/api/v2/authRedirect").trim();
